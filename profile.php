                  ...
                  <div class="card-body">
                    <div class="mt-5 d-flex align-items-start justify-content-between">
                      <div class="">
                        ...
                        <p>Sonipat, Haryana</p>
                        <div class="">
                          <span class="badge rounded-pill bg-dark">UX Research</span>
                          <span class="badge rounded-pill bg-dark">CX Strategy</span>
                          <span class="badge rounded-pill bg-dark">Project Management</span>
                        </div>
                      </div>
                      <div class="">
                         <a href="" class="btn btn-dark"><ion-icon name="send-sharp"></ion-icon>Send Message</a>
                      </div>
                    </div>
                  </div>
                </div>
